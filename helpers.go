...
func VideoBound(id, path string) Component {
	return Component{
		ID:    id,
		Video: &VideoDef{DataBinding: &DataBinding{Path: path}},
	}
}
...
func AudioPlayer(id, url, description string) Component {
	return Component{
		ID:          id,
		AudioPlayer: &AudioPlayerDef{URL: url, Description: description},
	}
}
...
func AudioPlayerBound(id, path, description string) Component {
	return Component{
		ID:          id,
		AudioPlayer: &AudioPlayerDef{DataBinding: &DataBinding{Path: path}, Description: description},
	}
}
...
func DividerVertical(id string) Component {
	return Component{
		ID:      id,
		Divider: &DividerDef{Orientation: "vertical"},
	}
}

// CheckBox creates a checkbox input component.
func CheckBox(id, label string, value bool) Component {
	return Component{
		ID:       id,
		CheckBox: &CheckBoxDef{Label: label, Value: value},
	}
}
...
func CheckBoxBound(id, label, path string) Component {
	return Component{
		ID:       id,
		CheckBox: &CheckBoxDef{Label: label, DataBinding: &DataBinding{Path: path}},
	}
}
...
func DateTimeInput(id, label string, enableDate, enableTime bool) Component {
	return Component{
		ID: id,
		DateTimeInput: &DateTimeInputDef{
			Label:      label,
...
func MultipleChoice(id, label string, options []ChoiceOption) Component {
	return Component{
		ID:             id,
		MultipleChoice: &MultipleChoiceDef{Label: label, Options: options},
	}
}
...
func ButtonPrimary(id, text, actionType string) Component {
	return Component{
		ID:     id,
		Button: &ButtonDef{Text: text, Action: Action{Type: actionType}, Primary: true},
	}
}
...
func TextWithHint(id, text string, hint UsageHint) Component {
	return Component{
		ID:   id,
		Text: &TextDef{Text: text, UsageHint: hint},
	}
}
...
func ImageWithFit(id, url, alt string, fit ImageFit) Component {
	return Component{
		ID:    id,
		Image: &ImageDef{URL: url, Alt: alt, Fit: fit},
	}
}
